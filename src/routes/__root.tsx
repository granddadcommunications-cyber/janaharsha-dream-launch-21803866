...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Janaharsha Plots — Residential Plots in Ibrahimpatnam" },
      { property: "og:description", content: "Open plots near Hyderabad with appreciation potential. Multiple phases across Ibrahimpatnam." },
